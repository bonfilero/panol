...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { codigo: @equipment.codigo, nombre: @equipment.nombre, ssystem_id: @equipment.ssystem_id }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { codigo: @equipment.codigo, nombre: @equipment.nombre, ssystem_id: @equipment.ssystem_id }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
